/*
 * File: FinalCutScene.cs
 * Authors: Mehar Johal
 * Created: 09/18/2023
 * Modified: 10/28/2023
 * Description: This script handles the cutscene transition between the defeating the boss (Boss Fight scene) and winning (Win Scene)
 * Contributions:
 *  Mehar Johal - 
 *  (Sole contributor)
 */
...
public class FinalCutScene : MonoBehaviour
{
    ...
    public string sceneToLoad = "MainMenu"; // The name of the scene you want to load
